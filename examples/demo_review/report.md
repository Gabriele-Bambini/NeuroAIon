...
> Model: `cowork (Claude, illustrative data)` (MOCK / offline demo) · Run: `demo` · 2026-06-14T14:34:15.082136
...
1. Author1 A, Bianchi L. Anodal tDCS improves n-back accuracy over left DLPFC. NeuroImage (demo). 2013. https://doi.org/10.9999/demo.001
2. Author2 A, Bianchi L. Single-session tDCS and working memory: a crossover RCT. NeuroImage (demo). 2015. https://doi.org/10.9999/demo.002
3. Author3 A, Bianchi L. Prefrontal tDCS enhances 2-back performance. NeuroImage (demo). 2012. https://doi.org/10.9999/demo.003
4. Author4 A, Bianchi L. No reliable effect of tDCS on spatial working memory. NeuroImage (demo). 2018. https://doi.org/10.9999/demo.004
5. Author5 A, Bianchi L. tDCS over DLPFC and executive working memory. NeuroImage (demo). 2016. https://doi.org/10.9999/demo.005
