...
\maketitle
\begin{abstract}
Background: Anodal tDCS over the left DLPFC has been proposed to enhance working memory. Methods: PRISMA 2020 systematic review with random-effects meta-analysis of n-back accuracy (Hedges g); RoB2 and GRADE. Results: Five illustrative trials were pooled. Conclusions: The evidence suggests a small, uncertain benefit. (DEMONSTRATION --- illustrative data.)
\end{abstract}
\section{Introduction}
Working memory is central to cognition, and non-invasive prefrontal stimulation has been explored as an enhancer. Evidence to date is heterogeneous and contested.
\section{Methods}
...
\toprule
Study & \rotatebox{0}{Randomization } & \rotatebox{0}{Deviations fro} & \rotatebox{0}{Missing outcom} & \rotatebox{0}{Measurement of} & \rotatebox{0}{Selection of t} & Overall \\
\midrule
\endhead
...
\bottomrule
\caption{Risk-of-bias assessment (RoB2).}
\end{longtable}
...
Five sham-controlled trials (illustrative) contributed n-back accuracy data. The pooled standardised mean difference indicated a small benefit of anodal left-DLPFC tDCS, with the confidence interval spanning the null in the more conservative estimates --- a pattern consistent with the broader, contested tDCS working-memory literature.
...
\section{Discussion}
The pooled estimate points to a small effect with wide uncertainty. Unclear blinding and small samples temper confidence; results should be read as hypothesis-generating.

\textbf{Limitations.} Small samples, single-session designs, and possible small-study effects.
\section{Conclusions}
Anodal left-DLPFC tDCS may yield a small improvement in n-back accuracy, but the certainty is low. Adequately powered, pre-registered trials are needed.
\appendix
