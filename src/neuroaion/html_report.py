...
<h1>{esc(p.title)}</h1>
<p class="muted">{esc(p.byline_full())}</p>
<p class="muted">Systematic review and meta-analysis · PRISMA 2020</p>
...
<hr><p class="muted">Systematic review and meta-analysis reported in accordance with
 PRISMA 2020. Supplementary files: report.md, paper.tex (LaTeX→PDF),
 prospero_registration.md, state.json.</p>
</body></html>"""
